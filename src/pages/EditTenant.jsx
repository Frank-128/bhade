  ...
  return (
    <div className="flex  bg-slate-600  justify-center ml:h-screen al:h-full ">
      <form className=" flex  ml:w-2/3 al:w-screen  h-fit ml:my-3 pb-2 ml:rounded-2xl bg-slate-400  flex-col items-center justify-center ">
        <i>
          <p className="pt-8 font-bold">Edit Tenant</p>
        </i>
        <div className="mt-6">
          <label className="block mb-2 font-bold text-sm  " htmlFor="firstname">
            FirstName:
          </label>
          <input
        ...
        <div className="mt-6">
          <label className="block mb-2 font-bold text-sm  " htmlFor="lastname">
            LastName:
          </label>
          <input
            className=" border-2 p-1 border-blue-400 rounded-xl w-64"
        ...
        <div className="mt-6">
          <label className="block mb-2 font-bold text-sm  " htmlFor="phoneNo">
            Phone Number:
          </label>
          <input
            className=" border-2 p-1 border-blue-400 rounded-xl w-64"
        ...
        <br />
        <div className="mb-6">
          <label className="block mb-2 font-bold text-sm  " htmlFor="amountPaid">
            Amount Paid:
          </label>
          <input
            className=" border-2 p-1 border-blue-400 rounded-xl w-64"
        ...
        <div className="mb-6">
          <label className="block mb-2 font-bold text-sm  " htmlFor="contract">
            Contract:
          </label>
          <input
            type="file"
        ...
        <div className="mb-6">
          <label className="block mb-2 font-bold text-sm  " htmlFor="startDate">
            Contract StartDate:
          </label>
          <input
            type="date"
        ...
        <div className="mb-6">
          <label className="block mb-2 font-bold text-sm  " htmlFor="endDate">
            Contract EndDate:
          </label>
          <input
            type="date"
        ...
        <button
          type="submit"
          className="border-2 p-1 border-blue-400 bg-slate-600 text-white rounded-xl w-32 "
        >
          Edit Tenant
        </button>
      </form>
